package com.example.pdfwithwifiprinter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createPDFFile(String path) {
        ...
        try {
            ...
            document.addAuthor("Jagadeesh");
            document.addCreator("Pinninti");
            ...
            addNewItem(document, "#781295", Element.ALIGN_LEFT, orderNumberValueFont);
            ...
            addNewItem(document, "Jagadeesh", Element.ALIGN_LEFT, orderNumberValueFont);
...
//https://www.youtube.com/watch?v=gpH4Zr1ffnU&t=428s